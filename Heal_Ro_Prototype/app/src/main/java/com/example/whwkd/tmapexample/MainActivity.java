...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapPoint user = new MapPoint("user", 37.492095,127.007602);
        tmapview.setLocationPoint(user.getLongitude(),user.getLatitude());
        myMath.getClosestArr(m_mapPoint,user);
        String hospitalName = m_mapPoint.get(0).getName();
        String dist = "<font color=\"#ff2525\">1.6km</font>";
        String location = "서울특별시 서초구 반포동 123";
        String call ="1588-1511";

        Button recommend1 = (Button)findViewById(R.id.first_des);
        Button recommend2 = (Button)findViewById(R.id.addr);
        Button recommend3 = (Button)findViewById(R.id.call);
        recommend1.setBackgroundResource(R.drawable.round_corner);
        recommend2.setBackgroundResource(R.drawable.round_corner);
        recommend3.setBackgroundResource(R.drawable.round_corner);
        recommend1.setText(Html.fromHtml(hospitalName + "&nbsp;" + dist ));
        recommend2.setText(Html.fromHtml(  "&nbsp;" + location ));
        recommend3.setText(Html.fromHtml( "&nbsp;" + call));

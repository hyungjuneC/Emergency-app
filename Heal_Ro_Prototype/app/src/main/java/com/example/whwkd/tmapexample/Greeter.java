...
public class Greeter extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pref.getInt("intkey", 0) == 0) {
            ...
            //DataBase에 값을 입력
            mDbOpenHelper.insertColumn("서울 성심병원", "02-966-1616", "37.502041,127.004812");
            mDbOpenHelper.insertColumn("이화여자대학교의과대학부속목동병원", "02-2650-5114", "37.536762,126.886159");
            mDbOpenHelper.insertColumn("강동경희대학교의대병원", "1577-5800", "37.553652,127.157628");
            mDbOpenHelper.insertColumn("재단법인아산사회복지재단 서울아산병원", "1688-7575", "37.527160,127.108360");
            mDbOpenHelper.insertColumn("서울성모병원", "1588-1511", "37.502050,127.004876");
            mDbOpenHelper.insertColumn("한국원자력의학원원자력병원", "02-970-2114", "37.629068,127.082692");
